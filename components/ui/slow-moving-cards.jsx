            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center gap-2">
                <span className=" flex justify-center items-center">
                        <Image src={item.picture} alt="pic" width={600} height={600} className=" object-contain w-[50px] h-[50px] rounded-full" />
                </span>
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-white font-extrabold">
                    {item.name}
                  </span>
